...
class Owlidays2024 {
    ...
    constructor(midifile){
        ...
        this.midifile = midifile ? midifile : "Pogues_Fairy_Tale_In_New_York_City.mid";  // best one
    ...
    initVariables(){
        ...
        this.mididir = __dirname+"/../web/midi";

        // running the system
        this.WEBSOCKET_PORT= 8098;
        this.WEBSERVER_PORT = 3003;
        this.UDPLISTENPORT = 8089; // I've nset up a node-RED implementaiton that spews out /pareto/raddec and /pareto/dynamb json
